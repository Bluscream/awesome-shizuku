# awesome-shizuku (closed-source apps)

[Click here to return to the main list.](../README.md)

This sublist only contains applications that are closed-source.
...
* [UbikiTouch](https://play.google.com/store/apps/details?id=eu.toneiv.ubktouch) `IAP` 💰 - Add custom swipe-from-edge gestures to Android `Proprietary`
